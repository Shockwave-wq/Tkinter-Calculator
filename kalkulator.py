...
layar = Entry(root, width=24, borderwidth=8, font=("Arial", 14))
layar.grid(row=0, column=0, columnspan=8, padx=10, pady=10)

#kolom ataslh
btn_backspc = Button(root, text="⌫", padx=20, pady=10, font=("Arial", 8), command=hapus_satu)
btn_ac = Button(root, text="C", padx=20, pady=10, font=("Arial", 8), command=hapus_semua)
btn_persen = Button(root, text="%", padx=20, pady=10, font=("Arial", 8), command=lambda: klik("%"))
btn_bagi = Button(root, text="÷", padx=20, pady=10, font=("Arial", 8), command=lambda: klik("/"))
...
#kolom dan baris 789
btn_7 = Button(root, text="7", padx=20, pady=10, font=("Arial", 8), command=lambda: klik(7))
btn_8 = Button(root, text="8", padx=20, pady=10, font=("Arial", 8), command=lambda: klik(8))
btn_9 = Button(root, text="9", padx=20, pady=10, font=("Arial", 8), command=lambda: klik(9))
btn_x = Button(root, text="X", padx=20, pady=10, font=("Arial", 8), command=lambda: klik("*"))
...
#kolom dan baris 123
btn_1 = Button(root, text="1", padx=20, pady=10, font=("Arial", 8), command=lambda: klik(1))
btn_2 = Button(root, text="2", padx=20, pady=10, font=("Arial", 8), command=lambda: klik(2))
btn_3 = Button(root, text="3", padx=20, pady=10, font=("Arial", 8), command=lambda: klik(3))
btn_tambah = Button(root, text="+", padx=20, pady=10, font=("Arial", 8), command=lambda: klik("+"))
...
btn_negpos = Button(root, text="-/+", padx=20, pady=10, font=("Arial", 8), command=tukar_tanda)
btn_0 = Button(root, text="0", padx=20, pady=10, font=("Arial", 8), command=lambda: klik(0))
btn_koma = Button(root, text=",", padx=20, pady=10, font=("Arial", 8), command=lambda: klik(","))
btn_equal = Button(root, text="=", padx=20, pady=10, font=("Arial", 8), command=hitung)
